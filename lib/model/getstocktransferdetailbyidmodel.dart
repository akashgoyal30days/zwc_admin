class Getstocktransferdetailsbyidmodel {
  bool? status;
  Data? data;

  Getstocktransferdetailsbyidmodel({this.status, this.data});

  Getstocktransferdetailsbyidmodel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Products {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['id'] = this.id;
    data['stock_transfer_id'] = this.stockTransferId;
