...
import 'package:zwc/screens/Purchase/addpurchasewastedetails.dart';
import 'package:zwc/screens/Sales/addsaleswastedetails.dart';
import 'package:zwc/screens/StockTransfer/Add_stock_transfer_wastedetails.dart';

import '../../data/shared_preference.dart';

class AddPurchaseDeatils extends StatefulWidget {
  AddPurchaseDeatils({Key? key}) : super(key: key);

  @override
  State<AddPurchaseDeatils> createState() => _addcollectiondetailsState();
}

class _addcollectiondetailsState extends State<AddPurchaseDeatils> {
                      ...
                      child: TextButton(
                        ...
                        onPressed: () {
                          if (branchdropdownvalue != null) {
                            ...
                            Get.to(AddPurchaseWasteDeatailsScreen(
