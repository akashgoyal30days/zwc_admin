...
class AddPurchaseWasteDeatailsScreen extends StatefulWidget {
  final String? selecteddate;
  final String? selecttobranch;
  AddPurchaseWasteDeatailsScreen(
      {Key? key, required this.selecteddate, required this.selecttobranch})
      : super(key: key);

  @override
  State<AddPurchaseWasteDeatailsScreen> createState() =>
      _addwastedetailsState();
}

class _addwastedetailsState extends State<AddPurchaseWasteDeatailsScreen> {
  ...
  List<AddPurchasewasteData> WasteDetailsData = [];

  @override
  void initState() {
    purchasecontroller.getallproductlistt();
                            ...
                            if (ratescontroller.text.isNotEmpty) {
                              if (quantitycontroller.text.isNotEmpty) {
                                if (selectwastedropdownvalue != null) {
                                  WasteDetailsData.add(AddPurchasewasteData(
                                      Date: widget.selecteddate,
                                      tobrannchid: widget.selecttobranch,
                                      Productid: selectwastedropdownvalue,
                                      Productname: purchasecontroller
                                          .getallproductlist!.data!
                                          .where((element) =>
                                              element.id.toString() ==
                        ...
                        child: TextButton(
                          ...
                          onPressed: () {
                            if (WasteDetailsData.isNotEmpty) {
                              purchasecontroller
                                  .uploadpurchasedata(WasteDetailsData)
                                  .then((value) => {
                                        if (value == true)
                                          {
