...
class Addsalesdetails extends StatefulWidget {
  Addsalesdetails({Key? key}) : super(key: key);

  @override
  State<Addsalesdetails> createState() => _addcollectiondetailsState();
}

class _addcollectiondetailsState extends State<Addsalesdetails> {
                      ...
                      child: TextButton(
                        ...
                        onPressed: () {
                          if (branchdropdownvalue != null) {
                            ...
                            Get.to(AddSalesWasteScreen(
                                selecteddate: selectdate,
                                selecttobranch: transferbranchid));

                            Get.deleteAll();
                          } else {
                            Get.snackbar("Sales", "Please Select Branch",
