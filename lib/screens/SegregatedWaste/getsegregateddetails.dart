...
class GetSegregatedDetails extends StatefulWidget {
  GetSegregatedDetails({
    Key? key,
  }) : super(key: key);

  @override
  State<GetSegregatedDetails> createState() =>
      _GetCollectionDetailsScreenState();
}

class _GetCollectionDetailsScreenState extends State<GetSegregatedDetails> {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextButton(
                          ...
                          onPressed: () {
                            ...
                            if (todate == null) {
                              Get.snackbar(
                                  "Segregated Details", "Please Select Date",
                                  backgroundColor: Colors.red,
                                  colorText: Colors.white,
                                  borderColor: Colors.white,
                                  borderWidth: 1);
                            } else {
                              segregatedcontroller.getsegregatedlist(
                      ...
                      segregatedcontroller.getallsegregatedlist == null
                          ? SizedBox()
                          : Column(
                              children: [
                                Container(
