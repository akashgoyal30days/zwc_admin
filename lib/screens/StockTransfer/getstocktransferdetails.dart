...
class GetStockTransferDetails extends StatefulWidget {
  GetStockTransferDetails({
    Key? key,
  }) : super(key: key);

  @override
  State<GetStockTransferDetails> createState() =>
      _GetCollectionDetailsScreenState();
}

class _GetCollectionDetailsScreenState extends State<GetStockTransferDetails> {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                        ...
                        child: TextButton(
                          ...
                          onPressed: () {
                            ...
                            if (todate == null) {
                              ...
                              stocktransfercontroller.getstocktransferlist(
                      ...
                      stocktransfercontroller.getallstocktransferlist == null
                          ? SizedBox()
                          : Column(
                              children: [
                                Container(
