...
class Addstocktransferwastedetails extends StatefulWidget {
  final String? selecteddate;
  final String? selecttobranch;
  Addstocktransferwastedetails(
      {Key? key, required this.selecteddate, required this.selecttobranch})
      : super(key: key);

  @override
  State<Addstocktransferwastedetails> createState() => _addwastedetailsState();
}

class _addwastedetailsState extends State<Addstocktransferwastedetails> {
  ...
  List<Addstocktransferwastedata> WasteDetailsData = [];

  @override
  void initState() {
    stocktransfercontroller.getallproductlistt();
                          ...
                          onPressed: () {
                            if (WasteDetailsData.isNotEmpty) {
                              stocktransfercontroller
                                  .uploadstocktransferdata(WasteDetailsData)
                                  .then((value) => {
                                        if (value == true)
                                          {
